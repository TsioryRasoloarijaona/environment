...
const ChartFive: React.FC =async () => {
    const list : [[string , number,number]] =await get('https://environment-pyv8.onrender.com/plants/percentage-by-category')
    const labels : string[] = [];
    const count : number[]= [];
    ...
    const options = {
      ...
      plugins: {
        ...
        title: {
          display: true,
          text: "plantation rate by categories",
        },
